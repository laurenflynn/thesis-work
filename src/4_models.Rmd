...
load(str_interp("~/thesis-work/RObjects/family_dfs/listOfDataFrames/familyinfo${numberFamilies}Families_no_for_each.Rdata"))

#load in the summary table of PanelPro results
load(str_interp("~/thesis-work/RObjects/summary_tables/summaryTable${numberFamilies}Families.Rdata"))
...
ggsave("indicatorsFirstDegAff.png")
```
