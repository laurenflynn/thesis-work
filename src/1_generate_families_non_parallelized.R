...
save(families, maskedFamilies, mlh1StatusFamilies, firstDegree, probandMLH1Status, probandIDS, numAffectedRelatives,numMLH1Relatives,numMLH1UnaffectedRelatives,numberFamilies, firstDegreeAffected, probandAffectionStatus, mlh1Freq, file = file_name)
