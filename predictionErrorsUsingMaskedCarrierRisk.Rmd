...
library(tidyverse)
library(xtable)
load("RObjects/summary_tables/summaryTable10000Families_no_censoring.Rdata")
```
...
all <- data.frame("Families"="All","Average full carrier risk score"=avg_full,"Average masked (unadjusted) carrier risk score"= avg_masked,"Average number of true carriers of MLH1"=avg_true,"Full MSE"=mse_full,"Masked MSE"=mse_masked)
```   
...
u1 <- data.frame("Families"="U1","Average full carrier risk score"=avg_full,"Average masked (unadjusted) carrier risk score"= avg_masked,"Average number of true carriers of MLH1"=avg_true,"Full MSE"=mse_full,"Masked MSE"=mse_masked)
```
...
a1 <- data.frame("Families"="A1","Average full carrier risk score"=avg_full,"Average masked (unadjusted) carrier risk score"= avg_masked,"Average number of true carriers of MLH1"=avg_true,"Full MSE"=mse_full,"Masked MSE"=mse_masked)
```
```{r}
tab <- rbind(all,a1,u1)
print(xtable(tab, digits=5), file = "carrierRiskValidation.tex")
```
