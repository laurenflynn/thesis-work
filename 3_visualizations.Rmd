...
library(tidyverse)
numberFamilies <- 1000
load(str_interp("RObjects/panelPROSummaryTable${numberFamilies}FamiliesNoForEach.Rdata"))
```
...
ggsave("1000familiesLogitRisksColorFirstDegreeAff.png")
```
...
ggsave("1000familiesLogitRisksColorProbandAff.png")
```
