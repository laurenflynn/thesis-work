...
for(i in lowerbound:upperbound){
  load(str_interp("RObjects/family_dfs/${numberFamilies}families/family_info_${numberFamilies}_families_no_for_each_${i}.Rdata"))
  families[[i]] = family
...
print("before running first degree")
load("~/PanelPRO/data/PanelPRODatabase.rda")
print(PanelPRODatabase$AlleleFrequency[["MLH1_anyPV",1]])
...
print("after running first degree families")
load("~/PanelPRO/data/PanelPRODatabase.rda")
print(PanelPRODatabase$AlleleFrequency[["MLH1_anyPV",1]])
...
file_name = str_interp("RObjects/summary_tables/job_array_1-200/panelPROSummaryTable${numberFamilies}Families${lowerbound}_${upperbound}.Rdata")
